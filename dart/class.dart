...
class RekeningBank { // sebelumnya string error dikarenakan sudah ada variabel sebelumnya
  var namaPemilik;
  var namaBank; 
  var saldo;
// pada this. harus dituliskan value pada variabel sebelumnya untuk memanggilnya
